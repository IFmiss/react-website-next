    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          _context.prev = 2;
          _context.next = 5;
          return _regeneratorRuntime.awrap((0, _unfetch["default"])("".concat(hotUpdatePath).concat(curHash, ".hot-update.json")));
